...
public class SpecialEffect implements Poolable {
    ...
    public static SpecialEffect newSpecialEffect(AnimationID animationID, AnimationType animationType, PlayMode playMode) {
	final SpecialEffect result = effectPool.obtain();

	result.animation = AnimationManager.getManager().getAnimation(animationID, animationType);
